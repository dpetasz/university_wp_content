...
<div class="full-width-split group">
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
            //tworzymy niestandardowe zapytanie
            $homepagePosts = new WP_Query(array(
                'posts_per_page' => 2, //pokazuj tylko dwa posty
                ...
                while ($homepagePosts->have_posts()) {
                    ...
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            ...
                            <p><?php
                                // funkcja umożliwia wyświetlenie 15 słów z funkcji która pobiera zawartość postu
                                echo wp_trim_words(get_the_content(), 15)
                                ?>
                                <a href="<?php the_permalink() ?>" class="nu gray">Czytaj więcej</a></p>
                        </div>
                    </div>
                <?php
            ...
            echo 'nie ma takich postów';
        }
        // funkcja resetująca wszystkie dane do stanu przed zapytaniem, powinniśmy ją zawsze używać po niestandardowych zapytaniach
        wp_reset_postdata();
        ?>
